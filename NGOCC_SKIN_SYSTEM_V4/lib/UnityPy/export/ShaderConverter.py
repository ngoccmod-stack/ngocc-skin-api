...
def export_shader(m_Shader):
    if hasattr(m_Shader, "m_SubProgramBlob"): 
    ...
    if hasattr(m_Shader, "compressedBlob"): 
...
def ConvertSerializedShaderState(m_State):
    ...
    if m_State.zTest.val != 4:
        sb.append(" ZTest ")
        if m_State.zTest.val == 0: 
            sb.append("Off")
        elif m_State.zTest.val == 1: 
            sb.append("Never")
        elif m_State.zTest.val == 2: 
            sb.append("Less")
        elif m_State.zTest.val == 3: 
            sb.append("Equal")
        elif m_State.zTest.val == 5: 
            sb.append("Greater")
        elif m_State.zTest.val == 6: 
            sb.append("NotEqual")
        elif m_State.zTest.val == 7: 
            sb.append("GEqual")
        elif m_State.zTest.val == 8: 
            sb.append("Always")

        sb.append("\n")

    if m_State.zWrite.val != 1: 
        sb.append(" ZWrite Off\n")

    if m_State.culling.val != 2: 
        sb.append(" Cull ")
        if m_State.culling.val == 0: 
            sb.append("Off")
        elif m_State.culling.val == 1: 
            sb.append("Front")
