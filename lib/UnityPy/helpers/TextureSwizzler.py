...
TEXTURE_FORMAT_BLOCK_SIZE_MAP: Dict[TextureFormat, Tuple[int, int]] = {
    TextureFormat.Alpha8: (16, 1),  
    TextureFormat.ARGB4444: (8, 1),  
    TextureFormat.RGBA32: (4, 1),  
    TextureFormat.ARGB32: (4, 1),  
    TextureFormat.RGBAFloat: (1, 1),  
    TextureFormat.RGB565: (8, 1),  
    TextureFormat.R16: (8, 1),  
    TextureFormat.DXT1: (8, 4),  
    TextureFormat.DXT5: (4, 4),  
    TextureFormat.RGBA4444: (8, 1),  
    TextureFormat.BGRA32: (4, 1),  
    TextureFormat.BC6H: (4, 4),  
    TextureFormat.BC7: (4, 4),  
    TextureFormat.BC4: (8, 4),  
    TextureFormat.BC5: (4, 4),  
    TextureFormat.ASTC_RGB_4x4: (4, 4),  
    ...
    TextureFormat.RG16: (8, 1),  
    TextureFormat.R8: (16, 1),  
}
