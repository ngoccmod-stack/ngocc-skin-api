...
class SpriteSettings:
    def __init__(self, reader):
        ...
        self.packed = self.settingsRaw & 1  
        self.packingMode = SpritePackingMode((self.settingsRaw >> 1) & 1)  
        self.packingRotation = SpritePackingRotation((self.settingsRaw >> 2) & 0xF)  
        self.meshType = SpriteMeshType((self.settingsRaw >> 6) & 1)  
